                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('informacions.destroy',$informacion->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('informacions.show',$informacion->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('informacions.edit',$informacion->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
